...
class DatasetAttr:
    ...
    # TODO: add seqreorder format
    formatting: Literal["alpaca", "sharegpt", "seqreorder"] = "alpaca"
    ...
    # TODO: add text column for pre-training
    ...
    def join(self, attr: dict[str, Any]) -> None:
        ...
        if "columns" in attr:
            ...
            # TODO: add text column for pre-training
            column_names += ["images", "videos", "audios", "chosen", "rejected", "kto_tag", "text"]
