...
def _get_preprocessed_dataset(
    ...
    dataset = dataset.map(
        ...
        features=Features({
            ...
            "token_types": Sequence(Value("int64")),
            # ===== string, not Image / Video =====
            "images": Sequence(Value("string")),
            "videos": Sequence(Value("string")),
            "audios": Sequence(Value("string")),
            # ===== structure =====
            "range_all": Sequence(Sequence(Value("int64"))),
            "ground_truth": Sequence(Value("int64")),
            "has_image": Sequence(Value("int64")),
            "has_video": Sequence(Value("int64")),
            "passage_length": Value("int64"),
        }),
        **kwargs,
    )
